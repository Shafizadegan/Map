...
const MapComponent = () => {
    ...
    useEffect(() => {
        ...
        sse.onmessage = (event) => {
            ...
            console.log(`origin_lng:${origin_lng}  origin_lat:${origin_lat}  destination_lng:${destination_lng}  destination_lat:${destination_lat}`)
        }
        sse.onerror = () => {
    ...
    useEffect(() => {
        if (!map) {
            ...
            mapInstance.on('load', () => {
                ...
                //     if (withinBounds) {console.log(document.getElementById('element-id').style.color = 'cornflowerblue')}
                // });

                // mapInstance.on('mouseleave', (e) => {
                //     const clickedLngLat = e.lngLat;
                //     const withinBounds =
                //     clickedLngLat.lng >= iranBoundingBox[0][0] &&
                //     clickedLngLat.lng <= iranBoundingBox[1][0] &&
                ...
                // if (withinBounds) {console.log(document.getElementById('element-id').style.color ='black')}
                // });
